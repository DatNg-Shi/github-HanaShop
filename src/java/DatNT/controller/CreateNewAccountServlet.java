...
public class CreateNewAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ((!userID.trim().matches(regex))) {
                foundError = true;
                errors.setNoSpecialCharacter("Empty or No special characters, length requires from 6 to 20 chars!!!");
            }
            ...
            if (foundError) {
                ...
                boolean result = dao.createNewAccount(userID, password, fullName, role);
            ...
            if (ex.getMessage().contains("duplicate")) {
                errors.setUserIDIsExisted(userID + " is existed!!!");
                request.setAttribute("CREATEERRORS", errors);
            }
