...
public class ViewFoodServlet extends HttpServlet {
    ...
    private final String INFOFOOD_PAGE = "foodDetail.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (!pk.equals("")) {
                ...
                FoodDTO dto = dao.viewFood(pk);
                dao.getCategory();

                List<FoodDTO> listCategory = dao.getListCategory();
                System.out.println(listCategory + " --- listCategory 1");
            ...
            log("ViewFoodServlet _ SQLException: " + ex.getMessage());
        } catch (NamingException ex) {
            log("ViewFoodServlet _ NamingException: " + ex.getMessage());
        } finally {
