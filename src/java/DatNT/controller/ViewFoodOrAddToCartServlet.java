...
public class ViewFoodOrAddToCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(button.matches("viewItem")){
                url = VIEW_ITEM_SERVLET;
            }
            else if(button.matches("Add to cart")){
                url = ADD_TO_CART_SERVLET;
            }
            else if(button.matches("Return to product page")){
